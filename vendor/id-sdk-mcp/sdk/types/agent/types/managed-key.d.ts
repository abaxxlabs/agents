...
export type GenerateKeyOptionTypes = IDCrypto.AlgorithmIdentifier | IDCrypto.AesGenerateKeyOptions | IDCrypto.EcdsaGenerateKeyOptions | IDCrypto.EdDsaGenerateKeyOptions;
export type GenerateKeyType<T> = T extends IDCrypto.EcGenerateKeyOptions ? ManagedKeyPair : T extends IDCrypto.AesGenerateKeyOptions ? ManagedKey : T extends IDCrypto.AlgorithmIdentifier ? ManagedKey | ManagedKeyPair : never;

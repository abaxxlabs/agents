...
export class Record {
    ...
    send(target) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof target === 'string') {
                result = yield this._agent.sendDwnRequest({
     ...
     */
    sendWithSelectiveDisclosure(target, options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isDeleted) {
            ...
            const derived = yield BbsCredential.deriveProof(bundle, {
                issuerPublicKey,
                revealedAttributes,
                nonce,
            });
            ...
            const messageOptions = Object.assign(Object.assign({}, this.toJSON()), { dataFormat: VC_DATA_FORMAT_LDP });
            if (schema)

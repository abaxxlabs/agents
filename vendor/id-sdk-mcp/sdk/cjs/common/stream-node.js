...
exports.NodeStream = exports.Readable = void 0;
const readable_stream_1 = require("readable-stream");
const stream_js_1 = require("./stream.js");
const convert_js_1 = require("./convert.js");
var readable_stream_2 = require("readable-stream");
Object.defineProperty(exports, "Readable", { enumerable: true, get: function () { return readable_stream_2.Readable; } });
class NodeStream {
    /**
    ...
    static async consumeToArrayBuffer({ readable }) {
        const arrayBuffer = await convert_js_1.Convert.asyncIterable(readable).toArrayBufferAsync();
        return arrayBuffer;
    }
    /**
    ...
    static async consumeToBlob({ readable }) {
        const blob = await convert_js_1.Convert.asyncIterable(readable).toBlobAsync();
        return blob;
    }
    /**
    ...
    static async consumeToBytes({ readable }) {
        const bytes = await convert_js_1.Convert.asyncIterable(readable).toUint8ArrayAsync();
        return bytes;
    }
    /**
    ...
    static async consumeToJson({ readable }) {
        const object = await convert_js_1.Convert.asyncIterable(readable).toObjectAsync();
        return object;
    }
    /**
    ...
    static async consumeToText({ readable }) {
        const text = await convert_js_1.Convert.asyncIterable(readable).toStringAsync();
        return text;
    }
    /**
    ...
    static fromWebReadable({ readableStream, readableOptions }) {
        if (!stream_js_1.Stream.isReadableStream(readableStream)) {
            throw new TypeError(`NodeStream.fromWebReadable: 'readableStream' is not a Web ReadableStream.`);
        }
        const reader = readableStream.getReader();
        let closed = false;
        const nodeReadable = new readable_stream_1.Readable(Object.assign(Object.assign({}, readableOptions), { read: function () {

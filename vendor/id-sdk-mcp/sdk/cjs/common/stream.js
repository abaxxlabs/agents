...
class Stream {
    ...
    static async consumeToArrayBuffer({ readableStream }) {
        ...
        const arrayBuffer = await convert_js_1.Convert.asyncIterable(iterableStream).toArrayBufferAsync();
        return arrayBuffer;
    }
    /**
    ...
    static async consumeToBlob({ readableStream }) {
        const iterableStream = Stream.asAsyncIterator(readableStream);
        const blob = await convert_js_1.Convert.asyncIterable(iterableStream).toBlobAsync();
        return blob;
    }
    /**
    ...
    static async consumeToBytes({ readableStream }) {
        const iterableStream = Stream.asAsyncIterator(readableStream);
        const bytes = await convert_js_1.Convert.asyncIterable(iterableStream).toUint8ArrayAsync();
        return bytes;
    }
    /**
    ...
    static async consumeToJson({ readableStream }) {
        const iterableStream = Stream.asAsyncIterator(readableStream);
        const object = await convert_js_1.Convert.asyncIterable(iterableStream).toObjectAsync();
        return object;
    }
    /**
    ...
    static async consumeToText({ readableStream }) {
        const iterableStream = Stream.asAsyncIterator(readableStream);
        const text = await convert_js_1.Convert.asyncIterable(iterableStream).toStringAsync();
        return text;
    }
    /**

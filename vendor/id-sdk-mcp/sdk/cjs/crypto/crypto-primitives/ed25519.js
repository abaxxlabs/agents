...
class Ed25519 {
     ...
     */
    static async convertPrivateKeyToX25519(options) {
        const { privateKey } = options;
        // Converts Ed25519 private key to X25519 private key.
        const montgomeryPrivateKey = (0, ed25519_1.edwardsToMontgomeryPriv)(privateKey);
   ...
   */
    static async convertPublicKeyToX25519(options) {
        ...
        const montgomeryPublicKey = (0, ed25519_1.edwardsToMontgomeryPub)(publicKey);
    ...
    static async sign(options) {
        ...
        // Signature operation.
        const signature = ed25519_1.ed25519.sign(data, key);
        return signature;
    }
    /**
    ...
    static async validatePublicKey(options) {
        ...
        try {
            ...
            const point = ed25519_1.ed25519.ExtendedPoint.fromHex(key);
    ...
    static async verify(options) {
        ...
        // Verify operation.
        const isValid = ed25519_1.ed25519.verify(signature, data, key);
        return isValid;
    }
}

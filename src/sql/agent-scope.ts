 ...
 * Its public identity and query flows do not call the backend's session store.
 */
export class AgentScope implements AgentScopeInstance {
  ...
  async createPresentationForAgent(options: {
    ...
    return this.identity.createPresentationForAgent(options);
  }
  ...
  async getAgent(
    ...
    return this.identity.getAgent(did);
  }

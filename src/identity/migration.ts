...
import type { RegisteredAgent, AgentSigner, MigrationCredentialClaims, MigrationAuditFields } from '#types/index.js';

export type { MigrationCredentialClaims, MigrationAuditFields } from '#types/index.js';
export { IDENTITY_MIGRATION_CREDENTIAL } from '#types/index.js';
import { DidAliasRegistry, type DidAlias } from '#did/alias.js';
import { AuditLogger, hashCredential } from '#audit/index.js';

...
// Tests provider-specific ceiling resolvers: routing, provider confusion prevention, fail-closed behavior.

import { describe, it, expect } from 'vitest';
import { resolveScopeCeilingFromClaims } from '../src/auth/ceiling.js';

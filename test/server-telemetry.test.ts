...
/**
 * Telemetry security contract: events may include hashes and counters,
 * but must not expose raw credentials, tokens, SQL, connection strings,
 * private keys, stack traces, or storage failure messages.
 */
...
import { createSigner, generateDidKey } from '../src/auth/index.js';

## [0.27.3](https://github.com/abaxxtech/agents/compare/v0.27.2...v0.27.3) (2026-08-25)


### Bug Fixes

* **sync:** unblock generated public mirror checks ([50b7425](https://github.com/abaxxtech/agents/commit/50b7425d7cffb413b8b20cd27be47b6f23f71802))

## [0.27.2](https://github.com/abaxxtech/agents/compare/v0.27.1...v0.27.2) (2026-08-25)


### Bug Fixes

* **sync:** exclude private-coupled tests from public sync ([9640f5e](https://github.com/abaxxtech/agents/commit/9640f5e9a96f7a8dbc23e0e43d3dc31685855314))

## [0.27.1](https://github.com/abaxxtech/agents/compare/v0.27.0...v0.27.1) (2026-08-25)


### Bug Fixes

*: add Agents rule to CodeQL ([380a432](https://github.com/abaxxtech/agents/commit/380a4324cd2f2ea2643a3b0144a955b5a78748a3))
*: add configurable auth rate limiting ([e4975f8](https://github.com/abaxxtech/agents/commit/e4975f85f1a3fefdbcbd71a2fb326ad2031077d0))

# [0.27.0](https://github.com/abaxxtech/agents/compare/v0.26.1...v0.27.0) (2026-08-25)


### Features

* **footer:** add custom footer component with branding and links ([0cbad41](https://github.com/abaxxtech/agents/commit/0cbad41225e4b1bd6b789613aaf206a0003f2277))

## [0.26.1](https://github.com/abaxxtech/agents/compare/v0.26.0...v0.26.1) (2026-08-25)


### Bug Fixes

* **docs:** update GitHub Pages configuration and README for base path handling ([4a4e13a](https://github.com/abaxxtech/agents/commit/4a4e13a3680dd534e7b0e703f24a17cd7017ead7))
* **workflow:** update permissions and handle GitHub Pages base path for pull requests ([e40dea9](https://github.com/abaxxtech/agents/commit/e40dea9b1955de36ba7193d7f8efed3394f407e8))

# [0.26.0](https://github.com/abaxxtech/agents/compare/v0.25.0...v0.26.0) (2026-08-25)


### Bug Fixes

* **server:** rate-limit admin audit chain verification route ([ba90d83](https://github.com/abaxxtech/agents/commit/ba90d832d1d56ddb1470c01b3ca15b3ef83435ed))
* **server:** remove duplicate admin chain rate-limit constants ([3498620](https://github.com/abaxxtech/agents/commit/3498620d0488ce210d7bcc6b9844edc476328276))


### Features

* **server:** add admin global audit chain verification endpoint ([876f58e](https://github.com/abaxxtech/agents/commit/876f58ea8685ef399f061576b6de2c3f4de9be41))

# [0.25.0](https://github.com/abaxxtech/agents/compare/v0.24.0...v0.25.0) (2026-08-25)


### Features

*: add artifact audit and preparation scripts ([b8fee45](https://github.com/abaxxtech/agents/commit/b8fee454b508f8ee74710ca123f4fdc9a3e4b000))

# [0.24.0](https://github.com/abaxxtech/agents/compare/v0.23.2...v0.24.0) (2026-08-25)


### Bug Fixes

* **server:** add rate limiting for present and query endpoints ([d32d312](https://github.com/abaxxtech/agents/commit/d32d312451fb002fb24e455473f9585f8f8a4aee))


### Features

* **server:** add /present endpoint for VP creation ([ab5c511](https://github.com/abaxxtech/agents/commit/ab5c51170442f7ae900d123e48d6f40ac3ea25cb))

## [0.23.2](https://github.com/abaxxtech/agents/compare/v0.23.1...v0.23.2) (2026-08-25)


### Bug Fixes

* Test gbrain implementation with agent ([240fe7b](https://github.com/abaxxtech/agents/commit/240fe7b77489962626c3abdb826a606e52064482))
* ([de20510](https://github.com/abaxxtech/agents/commit/de205104abaa663f55f64d4ec3bffeba6910e3ee))

## [0.23.1](https://github.com/abaxxtech/agents/compare/v0.23.0...v0.23.1) (2026-08-25)


### Bug Fixes

*: Admin API key comparison is not constant-time ([061a7ab](https://github.com/abaxxtech/agents/commit/061a7ab82de2fbac1c460e9fdfaa0ba641d17f72))
